...
const roadmapSections = [
  {
    ...
    items: [
      ...
      "Imposta obiettivi chiari (net worth, cash flow, allocazione) e verifica i progressi ogni mese.",
    ],
  },
  {
    title: "Security",
  ...
  {
    title: "Prossime funzionalità",
    items: [
      "Dashboard avanzata",
      "Calcolo del tasso di risparmio",
      "Per utenti Lifetime: pacchetto AI opzionale a pagamento",
      "Budgeting",
      "Notifications system",
      "Rivedere l’allocazione nei Settings",
      "Affiliate revenue",
      "Target allocation automatico in base ai dati inseriti",
      "Gestione delle categorie",
      "Con Weisy: pianifica i tuoi progetti, scoprine la fattibilità e analizzali passo dopo passo",
      "Automazione prezzi con Cron",
      "Proiezioni su rendimento e transazioni",
      "Campo note (gestione crisi, etica investimenti, ecc.)",
      "Gestione plusvalenze/minusvalenze",
      "Cache strategy",
      "App macOS + iOS",
    ],
  },
